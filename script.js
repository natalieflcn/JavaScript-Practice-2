...
// 2.4 Below are two variables called bookTitle and bookAuthor. Reassign them with the values of the title and
// author properties of the first book object from the books array.

let bookTitle = 'unknown';
let bookAuthor = 'unknown';

//const obj = { title: bookTitle, author: bookAuthor };
//const { title: bookTitle, author: bookAuthor } = books[0];

({ title: bookTitle, author: bookAuthor } = books[0]);

console.log('Question 2.4' + bookTitle, bookAuthor);
...
//const {fri: {open: o, close: o} } = openingHours;

// const { thirdParty } = books[0];

// const { goodreads } = thirdParty;
// console.log(goodreads);

// const { rating: bookRatig } = goodreads;
...
// //1.3 Below is the nested ratings array that contains two other arrays. Destructure the
// //nested ratings arrays into two variables called rating and ratingsCount. In the
// //result of your destructuring, the ratings variable should store a number 4.19, and the
...
// //1.4 Below is the ratingStars array. Destructure it into three variables called
